...
function traerInformacion() {
    ...
    $.ajax({
        type: "GET",
        url: "https://g952dcce73c1796-db202109282342.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        dataType: "JSON",
...
function editarRegistro(numId) {
    ...
    $.ajax({
        url: "https://g952dcce73c1796-db202109282342.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/" + numId,
        type: 'GET',
        dataType: 'json',
